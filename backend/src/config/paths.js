...
export const HOOK_SETTINGS_FILE = path.join(CONFIG_DIR, "hook-settings.json");
export const GLOBAL_HOOKS_DIR = path.join(YYZ_DIR, "hooks");
export const GLOBAL_HOOKS_FILE = path.join(GLOBAL_HOOKS_DIR, "hooks.json");
...
export const LOCAL_MARKETPLACE_DIR = path.join(YYZ_DIR, ".plugin");
export const LOCAL_MARKETPLACE_FILE = path.join(LOCAL_MARKETPLACE_DIR, "marketplace.json");
